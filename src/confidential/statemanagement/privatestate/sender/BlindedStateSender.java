...
public abstract class BlindedStateSender extends Thread {
    ...
    private PolynomialPoint[] blindingShares;
    ...
    public void setBlindingShares(PolynomialPoint[] blindingShares) {
        lock.lock();
    ...
    public void run() {
        ...
        try {
            ...
            for (int i = 0; i < stateSenders.length; i++) {
                stateSenders[i].setBlindedShares(blindedShares[i]);
            }
